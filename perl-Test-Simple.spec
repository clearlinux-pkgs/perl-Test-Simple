...
Source0  : https://cpan.metacpan.org/authors/id/E/EX/EXODIST/Test-Simple-1.302210.tar.gz
...
%prep
%setup -q -n Test-Simple-1.302210
cd %{_builddir}/Test-Simple-1.302210
pushd ..
cp -a Test-Simple-1.302210 buildavx2
popd
