...
Source0  : https://cpan.metacpan.org/authors/id/E/EX/EXODIST/Test-Simple-1.302199.tar.gz
...
%prep
%setup -q -n Test-Simple-1.302199
cd %{_builddir}/Test-Simple-1.302199
pushd ..
cp -a Test-Simple-1.302199 buildavx2
popd
