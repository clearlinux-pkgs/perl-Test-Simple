...
Source0  : https://cpan.metacpan.org/authors/id/E/EX/EXODIST/Test-Simple-1.302201.tar.gz
...
%prep
%setup -q -n Test-Simple-1.302201
cd %{_builddir}/Test-Simple-1.302201
pushd ..
cp -a Test-Simple-1.302201 buildavx2
popd
