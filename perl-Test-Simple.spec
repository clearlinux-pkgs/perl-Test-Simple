...
Source0  : https://cpan.metacpan.org/authors/id/E/EX/EXODIST/Test-Simple-1.302191.tar.gz
...
%prep
%setup -q -n Test-Simple-1.302191
cd %{_builddir}/Test-Simple-1.302191
...
cp %{_builddir}/Test-Simple-1.302191/LICENSE %{buildroot}/usr/share/package-licenses/perl-Test-Simple/3751f685eb3de05ab33c37bf12cee5ade6eec1f9
if test -f Makefile.PL; then
