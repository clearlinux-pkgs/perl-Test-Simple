...
Source0  : https://cpan.metacpan.org/authors/id/E/EX/EXODIST/Test-Simple-1.302196.tar.gz
...
%prep
%setup -q -n Test-Simple-1.302196
cd %{_builddir}/Test-Simple-1.302196
pushd ..
cp -a Test-Simple-1.302196 buildavx2
popd
